...
const slidesDir = path.join(__dirname, 'output', runId, 'v1', 'html');
const exportDir = path.join(__dirname, 'output', runId, 'v1', 'png');
...
(async () => {
  console.log('Iniciando captura Liquid Mirror...');
  ...
  await browser.close();
  console.log('Captura concluída. Ativos salvos em ' + exportDir);
})();
